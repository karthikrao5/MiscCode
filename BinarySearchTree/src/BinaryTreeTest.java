...
public class BinaryTreeTest {
	...
	public void testAddNull() {
		//System.out.println("add null test");
		assertFalse(tree.add(null));
		//System.out.println("DONE ADD NULL");
	}
	...
	public void testAddOne() {
		...
		//System.out.println("DONE ADD ONE TEST");
	}

	@Test
	public void testAddMany() {
		//System.out.println("add many test");
		...
		assertFalse(tree.isEmpty());
		//System.out.println("DONE ADD MANY TEST");
	}

	@Test
	public void testAddDuplicate() {
		//System.out.println("add duplicate test");
		for (int i = 0; i < noRotateTraversals.length ; ++i) {
		...
		assertEquals(noRotateTraversals.length, tree.size());
		//System.out.println("DONE ADD DUPLICATE TEST");
	}
	...
	@Test
	public void testInOrderTraversalNotEmpty() {
		for (int i = 0; i < noRotateTraversals.length ; ++i) {
			tree.add(noRotateTraversals[i]);
		}
	...
	public void testRemoveHNode() {
		...
		String[] testArrayWithH = { "M", "K", "S", "D", "L", "N", "T", "A", "U"};

		for (int i = 0; i < levelorderRemoveRoot.length; ++i) {
			String s = list.get(i);
			assertEquals(s, testArrayWithH[i]);
		}
	}

	@Test
	public void testRemoveSNode() {
		for (int i = 0; i < noRotateTraversals.length ; ++i) {
			tree.add(noRotateTraversals[i]);
		}
		...
		String[] testArrayWithS = { "M", "H", "T", "D", "K", "N", "U", "A", "L"};

		for (int i = 0; i < levelorderRemoveRoot.length; ++i) {
			String s = list.get(i);
			assertEquals(s, testArrayWithS[i]);
		}
	}
