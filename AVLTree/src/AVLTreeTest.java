...
public class AVLTreeTest {
	...
	public void testAddNull() {
		//System.out.println("Add Null test BEGIN");
		assertFalse(tree.add(null));
		//System.out.println("Add Null test END");
	}

	@Test
	public void testAddOne() {
//		System.out.println("AddOne test BEGIN");
		assertTrue(tree.add("A"));
		assertEquals(1, tree.size());
		assertFalse(tree.isEmpty());
//		System.out.println("AddOne test END");
	}


	@Test
	public void testAddManyNoRotate() {
//		System.out.println("ADD MANY BEGIN");
...
//		System.out.println("\nlist: " + list);
		...
		for (int i = 0; i < noRotateTraversals.length ; ++i) {
			assertEquals(list.get(i), noRotateTraversals[i]);
			//System.out.println(list.get(i));
		}
		assertEquals(noRotateTraversals.length, tree.size());
		assertFalse(tree.isEmpty());
//		System.out.println("ADD MANY END");
	}

	@Test
	public void testAddDuplicate() {

//		System.out.println("DUPLICATE TEST BEGIN");
		for (int i = 0; i < noRotateTraversals.length ; ++i) {
...
//		System.out.println("\nlist: " + list);
		...
		assertEquals(noRotateTraversals.length, tree.size());
//		System.out.println("DUPLICATE TEST END");
...
//		System.out.println("Many Single Test end:");
...
//	}
	...
	@Test
	public void testGetInOrderEmpty() {
		List<String> list = tree.getInOrder();
		assertTrue(list.isEmpty());
	}

	@Test
	public void testGetInOrderNotEmpty() {
		for (int i = 0; i < noRotateTraversals.length ; ++i) {
			tree.add(noRotateTraversals[i]);
		}
		...
		for (int i = 0; i < inorderTraversal.length; ++i) {
			...
			//System.out.print(inorderTraversal[i] + " ");
		}
	}
